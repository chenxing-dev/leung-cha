...
export const MainLayout: React.FC<MainLayoutProps> = ({
  ...
  <div id="layout" className="flex h-full bg-paper border-6 border-wood">
    <aside className="overflow-x-hidden relative z-0">
      <HerbList
    ...
    <DecorativeDivider />
    <main className="flex-1 flex overflow-visible relative bg-paper z-0">
      <GroundGrid />
      <div className="flex flex-col items-center justify-around w-4/7 relative z-40">
        <ShopTitle />
        <PotArea potHerbs={potHerbs} setPotHerbs={setPotHerbs} setBoiledTeas={setBoiledTeas} />
      </div>
      <div id="recipe-info" className="w-3/7 pr-8 py-8 relative z-0">
