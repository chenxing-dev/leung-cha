...
export function useBoiling(
  potHerbs: string[],
  isFireOn: boolean,
  isBoiled: boolean,
  setBoilProgress: (n: number) => void,
  setIsBoiled: (b: boolean) => void,
) {
  ...
  }, [isFireOn, hasHerbs, isBoiled, potHerbs, setBoilProgress, setIsBoiled]);
}

export function usePotTip(
  potHerbs: string[],
  isFireOn: boolean,
  isBoiled: boolean,
  hasTeaBowl: boolean,
