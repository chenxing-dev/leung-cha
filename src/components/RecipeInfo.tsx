...
export function RecipeInfo({
  ...
  return (
    <ChineseFrame className="h-full">
      <div className="px-4 py-2">
        <div className="flex flex-col w-full h-60 text-3xl">
          <div className="flex items-center">
            <img
              src="decor/mortar_24x24.png"
              className="inline-block w-24 aspect-ratio"
          ...
          {herbList.length > 0 ? (
            <ul
              className="list-disc px-8 text-3xl grid xl:grid-cols-2 gap-x-4 gap-y-2 max-h-40 overflow-y-auto"
        ...
        <div className="flex flex-col flex-1 w-full text-3xl gap-2">
          <div className="flex items-center">
            <img
              src="containers/gourd_24x24_2.png"
              className="inline-block w-24 aspect-ratio"
              style={{ imageRendering: "pixelated" }}
            />
            ...
            <div className="h-72 overflow-y-auto">
              ...
              {boiledTeas
                ...
                .map((tea, idx) => (
                  <div
                    key={idx}
                    className="mt-2 p-1.5 bg-gold/30 border-6 border-gold rounded text-xl xl:text-3xl font-bold text-brown"
                  >
                    <p>{tea.name}</p>
